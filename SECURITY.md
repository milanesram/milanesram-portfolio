...
The current production-validated release is tagged `v1.2.0`. The previous Production release remains `v1.1.1`. The initial Production release remains `v1.0.0`.
