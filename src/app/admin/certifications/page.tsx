...
import { listAdminCertifications } from "@/lib/admin/certifications/queries";
    ...
    <div>
      ...
      {records.length === 0 && !error ? (
        <p className="mt-8 rounded-xl border border-dashed border-line bg-paper-elevated p-6 text-sm text-ink-soft">
          No certification records in Supabase yet. Create one here. Do not load
          real certification names or verification data in this step.
        </p>
      ) : (
              ...
              {records.map((record) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/admin/certifications/${record.id}`}
