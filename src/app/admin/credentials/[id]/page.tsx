...
import { getAdminCredential } from "@/lib/admin/credentials/queries";
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="max-w-2xl rounded-xl border border-line bg-paper-elevated p-6">
        <h3 className="font-serif text-xl text-ink">Credential details</h3>
        <div className="mt-6 space-y-5">
          <CredentialForm credential={result.data} />
          <DeleteCredentialButton
