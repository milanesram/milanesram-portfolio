...
import { getAdminTraining } from "@/lib/admin/training/queries";
...
export default async function EditTrainingPage({
  ...
  const result = await getAdminTraining(auth.supabase, id);
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="max-w-2xl rounded-xl border border-line bg-paper-elevated p-6">
        <h3 className="font-serif text-xl text-ink">Training details</h3>
        <div className="mt-6 space-y-5">
          <TrainingForm training={result.data} />
          <DeleteTrainingButton
